...
abstract class BaseHiveUseCase<E, Repo extends BaseHiveCRUDRepo<E>>
    extends GetxService {
...
class WatchUseCase<Repo extends BaseHiveCRUDRepo>
    extends UseCaseIO<dynamic, Stream<BoxEvent>> {
  final Repo repo;
