...
import 'package:scb_arch_demo/utils/extension/view_utils.dart';
...
class CommonScaffoldStyles {
  ...
  static CommonScaffoldStyle hideKeyBoardStyle() =>
      defaultStyle().copyWith(hideKeyboardWhenTouchOutside: true);
}
  ...
  CommonScaffoldStyle copyWith({
    ...
    return CommonScaffoldStyle(
      ...
      hideKeyboardWhenTouchOutside:
          hideKeyboardWhenTouchOutside ?? this.hideKeyboardWhenTouchOutside,
    );
  }
}
