import 'package:scb_arch_demo/base/base.dart';
import 'package:scb_arch_demo/features/authentication/data/providers/local/user_storage_ex.dart';
import 'package:scb_arch_demo/utils/extension/language_type.dart';
...
class ChangeLanguageController extends BaseController {
  ...
  void onSelectLanguage(int index) async {
    for (final i in languages) {
      i.isSelected.value =
          i.locale.languageCode == languages[index].locale.languageCode;
    }
